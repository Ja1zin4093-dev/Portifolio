...
const ElectricBorder = ({
  ...
  const updateAnim = () => {
    ...
    if (filterEl) {
      // garantir que o filtro cubra toda a área mesmo com deslocamentos
  ...
  // forçamos display inline-block por padrão para que o wrapper encaixe no tamanho do filho.
  const mergedStyle = { display: "inline-block", ...style, ...vars };
